...
After creating your own github repository and connecting it to your RStudio, you should work through the exercises provided in `L01_visualization.html`. A template is also provided (rename as `Lastname_Firstname_L01.qmd`).
